...
public class CacheModel extends AbstractModel {
	...
	private final Map<Long, List<Integer>> cachedRefs;
	...
	public void updateCache(List<Integer> input, int index) {
	...
	private long hashCode(List<Integer> arr) {
		final int prime = 31;
		long result = 1;
		for (Integer a : arr) {
