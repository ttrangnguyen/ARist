...
public class Tmp2 {
    public static void main(String[] args) {
        ...
        long trainTime = (System.currentTimeMillis() - startTrainTime) / 1000;
...
//        tokens.add("(");
//        tokens.add("int");
//        tokens.add("boxingGame");
//        tokens.add("=");
////        List<List<Double> > pred = modelRunner.predictContent("for (int i");
//        List<Integer> in = vocabulary.toIndices(tokens);
//        List<Map<Integer, Pair<Double, Double>>> stuff = modelRunner.getModel().predict(in);
...
//            System.out.println();
//        }
        long testTime = (System.currentTimeMillis() - startTestTime) / 1000;
