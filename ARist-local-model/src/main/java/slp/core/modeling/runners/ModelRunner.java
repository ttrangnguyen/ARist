...
public class ModelRunner implements Serializable{
	...
	public static final int DEFAULT_NGRAM_ORDER = ModelConfig.NGRAM;
	
	public static int GLOBAL_PREDICTION_CUTOFF = TestConfig.TOP_K;
	...
	public void predictFile(File f) {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(f))) {
			...
			while ((line = br.readLine()) != null) {
				...
				Gson gson = new Gson();
				MultipleParamRequest jsonRequest = gson.fromJson(line, MultipleParamRequest.class);
			}
