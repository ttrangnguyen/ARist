...
import analysis.structure.DataFrame;
...
import crawling.GitCloner;
import utils.file_reading.CSVReader;
import javassist.expr.Cast;
import analysis.structure.*;
import utils.file_processing.*;
...
public class JavaAnalyser {
    ...
    private void setOutputDir(String path) {
        ...
        if (f.isDirectory()) this.outputDir = path;
    }
    ...
    public static void main(String[] args) {
        ...
        analyser.setOutputDir("../../name_stat/input/");
        analyser.analyseAll();
    }
}
