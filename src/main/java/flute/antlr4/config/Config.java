...
public class Config {
    ...
    public static final String trainingPath = "excodeFiles/train/";
    public static final String testingPath = "excodeFiles/test/";
    public static final String validatingPath = "excodeFiles/validate/";
}
