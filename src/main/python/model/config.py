...
method_call_model_ngram_path = "../../../../../model/v4-10fold-ngram/" + str(ngram) + " gram/method_call_model_" \
...
method_call_tokenizer_path = '../../../../src/main/python/model/method_call/method_call_tokenizer'
