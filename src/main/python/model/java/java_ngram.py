...
train_len = 5 + 1
train_len_str = '6'
train_csv_path = '../../../../../../data_csv_' + train_len_str + '_gram/java/' + project + '/java_train_' + project + '.csv'
validate_csv_path = '../../../../../../data_csv_' + train_len_str + '_gram/java/' + project + '/java_validate_' + project + '.csv'
...
model_path = "../../../../../../model/java_model_" + project + train_len_str + "ngram.pkl"
